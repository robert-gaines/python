...
will worsen the situation. It will certainly subject human being to
...
much movement or an ideology as a psychological type, or rather a
...
which our discussion could be applied to the leftists of the 19th and
...
They may seem almost paranoid about anything that might suggest that any
primitive culture is inferior to ours. (We do not mean to imply that
primitive cultures ARE inferior to ours. We merely point out the hyper
...
human being inflict on one another.
...
the oversocialized type tend to be intellectuals or members of the
upper-middle class. Notice that university intellectuals [3] constitute
the most highly socialized segment of our society and also the most
leftwing segment.
...
technological system. The system couldn't care less what kind of music a
man listens to, what kind of clothes he wears or what religion he
...
women was common among the Australian aborigines, transexuality was
...
a small scale community, because if the internal loyalties of small-scale
communities were stronger than loyalty to the system, such communities
would pursue their own advantage at the expense of the system.
...
In those days an entire county might have only a couple of hundred
...
names such as "anomic" or "middle-class vacuity.") We suggest that the
...
them. ("We live in a world in which relatively few people -- maybe 500
or 1,000 make the important decisions" -- Philip B. Heymann of Harvard
...
with physical security. What makes us FEEL secure is not so much
...
generally do what we please. We can believe in any religion (as long as
it does not encourage behavior that is dangerous to the system). We can
go to bed with anyone we like (as long as we practice "safe sex"). We
can do anything we like as long as it is UNIMPORTANT. But in all
IMPORTANT matters the system tends increasingly to regulate our behavior.
...
adequate experience of the power process -- with real goals instead of
...
survives that long) and death. any modern people, on the other hand, are
disturbed by the prospect of physical deterioration and death, as is
shown by the amount of effort they expend trying to maintain their
...
process using their bodies in a serious way. It is not the primitive
...
whose need for the power process has been satisfied during his life who
...
destroyed by the very fact that society gives it to them. What they need
is to find or make their own opportunities. As long as the system GIVES
them their opportunities it still has them on a leash. To attain
...
don't mean to sneer at the "plantation darkies" of the Old South. To
...
techniques. Some are so susceptible that, even if they make a great deal
of money, they cannot satisfy their constant craving for the shiny
...
(attainment of goal). Thus the U.S. went through the power process and
many Americans, because of their identification with the U.S.,
experienced the power process vicariously. Hence the widespread public
approval of the Panama invasion; it gave people a sense of power. [15]
We see the same phenomenon in armies, corporations, political parties,
humanitarian organizations, religious or ideological movements. In
particular, leftist movements tend to attract people who are seeking to
satisfy their need for power. But for most people identification with a
large organization or a mass movement does not fully satisfy the need
for power.
...
muscles, hitting a little ball into a hole or acquiring a complete
...
effort constitutes a surrogate activity. This extra effort, together
with the emotional investment that accompanies it, is one of the most
potent forces acting toward the continual development and perfecting of
the system, with negative consequences for individual freedom (see
paragraph 131). Especially, for the most creative scientists and
engineers, work tends to be largely a surrogate activity. This point is
so important that it deserves a separate discussion, which we shall give
in a moment (paragraphs 87-92).
...
activities or by identification with an organization (see paragraphs 41,
64). In the second place, too much control is imposed by the system
...
about isopropyltrimethylmethane. In any case it is not normal to put
...
psychological needs of the scientists and of the government of officials
...
the sphere of human freedom. But, because "freedom" is a word that can
be interpreted in many ways, we must first make clear what kind of
...
media than to read a sober essay. Even ff these writings had had many
...
Thus the bourgeoise’s "free" man has economic freedom because that
...
bad for the system. This was clearly the attitude of Simon Bolivar. To
...
his community life requires such rights. By community Hu meant the whole
society of the nation." And on page 259 Tan states that according to
Carson Chang (Chang Chun-mai, head of the State Socialist Party in
...
transitory -- the trend will soon revert to its original state.
(Example: A reform movement designed to clean up political corruption in
...
corruption in a given society tends to remain constant, or to change
only slowly with the evolution of the society. Normally, a political
cleanup will be permanent only if accompanied by widespread social
changes; a SMALL change in the society won't be enough.) If a small
change in a long-term historical trend appears to be permanent, it is
only because the change acts in the direction in which the trend is
already moving, so that the trend is not altered by only pushed a step
ahead.
...
the road that English-speaking world was already traveling. The proof is
that Britain and all of its colonies that were populated predominantly
by people of British descent ended up with systems of representative
democracy essentially similar to that of the United States. If the
Founding Fathers had lost their nerve and declined to sign the
...
Congress and President. No big deal. Thus the American Revolution
provides not a counterexample to our principles but a good illustration
of them.
...
a transitory one -- soon swamped by the tide of history -- or, if large
...
pursuits -- just the sort of thing that boys like. But in our society
...
number of voters ordinarily is too large for the vote of any one
individual to be significant. [17] Thus most individuals are unable to
...
technical necessity. [18] Of course the system does satisfy many human
needs, but generally speaking it does this only to the extend that it is
...
to spend the bulk of their time studying subjects most of them hate.
When skilled workers are put out of a job by technical advances and have
to undergo "retraining," no one asks whether it is humiliating for them
...
needs were put before technical necessity there would be economic
...
survival and growth of the company. Any company would soon go out of
business if it permitted its employees to act otherwise. Similarly, in
any enterprise within a socialist system, workers must direct their
efforts toward the goals of the enterprise, otherwise the enterprise
...
the needs of the industrial-technological system. [20]
...
refuses. The powerful one says, "OK, let's compromise. Give me half of
...
especially im densely populated areas, one cannot just go where one
...
an individual has no power to influence. [21] The same process will
...
eliminates a hereditary disease. It does no apparent harm and
prevents much suffering. Yet a large number of genetic improvements
taken together will make the human being into an engineered product
rather than a free creation of chance (or of God, or whatever, depending
...
back, but technology can never take a step back -- short of the
...
useful, do not hesitate to collect information about individuals without
regard to their privacy. Law enforcement agencies are frequently
...
remain busy in their laboratories, and technology as it progresses would
...
dignity. Still, the technology would remain waiting. Sooner or later the
social arrangement would break down. Probably sooner, given the pace of
change in our society. Then genetic engineering would begin to invade
...
A few years ago its seemed that there were secure legal barriers
...
our natural resources for our grandchildren. [22] But on this subject we
...
application of any one segment of technology, such as genetic
...
society. We will have more to say about revolution in paragraphs 180-205.
...
disruption of the power process, as explained in paragraphs 59-76. But
even if we are wrong, the increasing rate of depression is certainly the
result of SOME conditions that exist in today's society. Instead of
removing the conditions that make people depressed, modern society gives
them antidepressant drugs. In effect, antidepressants are a means of
modifying an individual's internal state in such a way as to enable him
to tolerate social conditions that he would otherwise find intolerable.
(Yes, we know that depression is often of purely genetic origin. We are
referring here to those cases in which environment plays the predominant
role.)
...
hours at a time doing nothing at all, because they are at peace with
...
a conscious desire to restrict human freedom. [28] Each new step in the
...
For example, when a psychiatrist prescribes an anti-depressant for a
...
good purposes, such as discouraging child abuse or race hatred. [14] Sex
education is obviously useful, yet the effect of sex education (to the
extent that it is successful) is to take the shaping of sexual attitudes
...
mass entertainment. (Yet until quite recently in human histo}y most
...
clearly is less powerful that the biological mechanisms of human
...
no rational and effective public resistance. (See paragraphs 127, 132,
153.)
...
in one way or another are rebels against the system: welfare leaches,
...
so that heir behavior no longer threatens the system. That being
...
will die, since the world's population has become so over grown that it
...
the intrusion of industrial society has been that over much of the world
traditional controls on population have been thrown out of balance.
Hence the population explosion, with all that that implies. Then there
is the psychological suffering that is widespread throughout the
supposedly fortunate countries of the West (see paragraphs 44, 45). No
one knows what will happen as a result of ozone depletion, the
...
are impossible to predict (paragraph 103). The result is disruption of
the society. So it is very probable that in their attempts to end
poverty and disease, engineer docile, happy personalities and so forth,
the technophiles will create social systems that are terribly troubled,
even more so than the present once. For example, the scientists boast
that they will end famine by creating new, genetically engineered food
plants. But this will allow the human population to keep expanding
indefinitely, and it is well known that crowding leads to increased
stress and aggression. This is merely one example of the PREDICTABLE
problems that will arise. We emphasize that, as past experience has
shown, technical progress will lead to other new problems that CANNOT be
predicted in advance (paragraph 103). In fact, ever since the Industrial
Revolution, technology has been creating new problems for society far
more rapidly than it has been solving old ones. Thus it will take a long
and difficult period of trial and error for the technophiles to work the
bugs out of their Brave New World (if they every do). In the meantime
there will be great suffering. So it is not at all clear that the
survival of industrial society would involve less suffering than the
...
to guess how such machines might behave. We only point out that the fate
...
all power to the machines. But we are suggesting neither that the human
...
face it become more and more complex and as machines become more and
more intelligent, people will let machines make more and more of their
decisions for them, simply because machine-made decisions will bring
...
People won't be able to just turn the machine off, because they will be
...
become dissatisfied undergoes "treatment" to cure his "problem." Of
...
will be increasingly specialized, so that their work will be, in a
sense, out of touch with the real world, being concentrated on one tiny
slice of reality. The system will have to use any means that it can,
whether psychological or biological, to engineer people to be docile, to
have the abilities that the system requires and to "sublimate" their
drive for power into some specialized task. But the statement that the
...
there is endless competition for positions of prestige and power. But no
more than a very few people will ever reach the top, where the only real
power is (see end of paragraph 163). Very repellent is a society in
which a person can satisfy his need for power only by pushing large
...
-- well, you can't eat your cake and have it too. To gain one thing you
...
final push toward revolution [31], the task of revolutionaries will be
...
anxious to gain power for African Americans by placing back individuals
...
will be on technology and economics, not politics. [32]
...
would be massive unemployment, shortages of commodities, etc. Even if the
grosser ill effects could be avoided through superhumanly skillful
...
small groups but by large organizations. To the extent that the average
...
rid of the industrial system, because once the industrial system is gone
the world's population necessarily will decrease (see paragraph 167);
...
Smalll scale technology and organization dependent technology. Small-scale
...
of no significant cases of regression in small-scale technology. But
...
Empire fell apart the Romans' small-scale technology survived because
any clever village craftsman could build, for instance, a water wheel,
any skilled smith could make steel by Roman methods, and so forth. But
the Romans' organization- dependent technology DID regress. Their
...
forgotten, so that not until rather recent times did the sanitation of
...
or the facilities of a postindustrial machine shop it would be virtually
impossible for a handful of local craftsmen to build a refrigerator. If
by some miracle they did succeed in building one it would be useless to
them without a reliable source of electric power. So they would have to
dam a stream and build a generator. Generators require large amounts of
copper wire. Imagine trying to make that wire without modern machinery.
And where would they get a gas suitable for refrigeration? It would be
much easier to build an icehouse or preserve food by drying or picking,
...
world without rapid transportation and communication, you can't make all
...
base. Above all, leftism is driven by the need for power, and the
leftist seeks power on a collective basis, through identification with a
...
and technology: They will use it to oppress everyone else if they ever
...
leftism; it plays a vital role in his psychological economy. His beliefs
are not easily modified by logic or facts. He has a deep conviction that
leftism is morally Right with a capital R, and that he has not only a
right but a duty to impose leftist morality on everyone. (However, many
of the people we are referring to as "leftists" do not think of
themselves as leftists and would not describe their system of beliefs as
leftism. We use the term "leftism" because we don't know of any better
words to designate the spectrum of related creeds that includes the
feminist, gay rights, political correctness, etc., movements, and
...
the movement (see paragraph 83). But no matter how far the movement has
gone in attaining its goals the leftist is never satisfied, because his
...
in reality he is motivated by the sense of power he gets from struggling
for and then reaching a social goal. [35] Consequently the leftist is
never satisfied with the goals he has already attained; his need for the
power process leads him always to pursue some new goal. The leftist
wants equal opportunities for minorities. When that is attained he
insists on statistical equality of achievement by minorities. And as
long as anyone harbors in some corner of his mind a negative attitude
...
to be restricted ff not banned. The activists will never be satisfied
until tobacco is outlawed, and after that it will be alcohol, then junk
food, etc. Activists have fought gross child abuse, which is reasonable.
But now they want to stop all spanking. When they have done that they
will want to ban something else they consider unwholesome, then another
...
do. For them the drive for power has only one morally acceptable outlet,
and that is in the struggle to impose their morality on everyone.
...
for pursuing that other ideal (see paragraphs 220, 221).
...
in Vietnam, but when the USSR invaded Afghanistan they did nothing. Not
that they approved of the Soviet actions; but because of their leftist
faith, they just couldn't bear to put themselves in opposition to
communism. Today, in those of our universities where "political
correctness" has become dominant, there are probably many leftish types
who privately disapprove of the suppression of academic freedom, but
they go along with it anyway.

226. Thus the fact that many individual leftists are personally mild and
fairly tolerant people by no means prevents leftism as a whole form
...
action, for multi- culturalism. He tends to identify with victims. He
...
the common catch-phrases of the left, like "racism," "sexism,"
...
victims can be seen to some extent in 19th century leftism and early
Christianity but as far as we can make out, symptoms of low self-esteem,
etc., were not nearly so evident in these movements, or in any other
movements, as they are in modern leftism. But we are not in a position
to assert confidently that no such movements have existed prior to
modern leftism. This is a significant question to which historians ought
to give their attention.

    """
    #
    extract_words = book_text.split('\n')
    #
    book_list = list(extract_words)
    #
    word_list = []
    #
    for b in book_list:
        #
        word_list.append(b.split(' '))
        #
    return book_list
